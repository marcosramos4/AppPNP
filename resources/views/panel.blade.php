        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
            <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="/dashboard"
                           class="text-white nav-link {{activeMenu('dashboard')}} {{activeMenu('dashboard/*')}} ">
                            <svg class="bi pe-none me-2" width="16" height="16">
...
@if(session()->has('mensaje'))
    <div class="toast-container position-fixed bottom-0 end-0 {{session()->get('tipo')}} alert p-0">
        <div id="liveToast" class="toast bg-transparent" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                <strong class="me-auto ">{{session()->get('titulo')}}</strong>
    ...
    <script>
        ...
        window.addEventListener('load', function () {
            ...
            const mytoas = new bootstrap.Toast(toastElList);
            mytoas.show();
        });
